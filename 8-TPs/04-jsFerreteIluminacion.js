...
function CalcularPrecio () 
{
    ...
    precioDescuento = precioUnidad - (precioUnidad * descuento);
    precioTotal = precioDescuento * cantidadLamp;

    document.getElementById("txtIdprecioDescuento").value = precioDescuento;
    alert("El precio total es " + precioTotal);

    if (precioTotal >= 120){    
        ingresosBrutos = precioTotal * 0.1;
        precioFinal = precioTotal + ingresosBrutos;
